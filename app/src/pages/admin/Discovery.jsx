...
export default function Discovery({ sidebarCollapsed, setSidebarCollapsed }) {
  ...
  // "Build fresh 20" — confirms both sides at once (drafted DM for hosts,
  // queued status for creators), topping up with a live HikerAPI search first
  // if the pool's short. Does NOT email anyone — that's always a separate,
  ...
  async function handleBuildQueue() {
    ...
    try {
      const r = await buildFreshQueue({ perKind: 20 });
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexShrink: 0 }}>
          <button onClick={handleBuildQueue} disabled={queueBusy}
            title="Confirms up to 20 new creators and 20 new hosts each — drafts DMs, tops up with a live HikerAPI search first if the pool's short. Emailing is a separate step you trigger yourself; Instagram DM volume stays capped separately."
            ...
            {queueBusy ? 'Building…' : 'Build fresh 20'}
          </button>
