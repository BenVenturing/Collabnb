...
const ICONS = {
  ...
  'money-overview': IC(<><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></>),
  'charge-approvals': IC(<><circle cx="12" cy="12" r="10"/><polyline points="8 12 11 15 16 9"/></>),
  payouts:      IC(<><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>),
  'money-resources': IC(<><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></>),
