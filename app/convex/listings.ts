...
const SAMPLE_LISTINGS = [
      {
        ...
        rating: 4.97,
        review_count: 84,
        compensation: "$1,000 + 3-night stay",
        compensation_type: "hybrid",
        cash_amount: 1000,
        collab_type: "UGC Video",
        creator_tier: "UGC Pro",
        deliverables: "5 UGC Reels, 10 Photos",
        ...
        what_you_deliver: "15 total deliverables across 2 formats (Heavy load)",
        requirements: [
      ...
      },
      {
        ...
        rating: 4.93,
        review_count: 112,
        compensation: "$1,000 + 2-night stay",
        compensation_type: "hybrid",
        cash_amount: 1000,
        collab_type: "Instagram Reels",
        creator_tier: "Micro Influencer",
        deliverables: "5 Influencer Reels, 8 Photos",
        ...
        what_you_deliver: "13 total deliverables across 2 formats (Custom campaign)",
        requirements: [
      ...
      },
      {
        ...
        rating: 4.95,
        review_count: 203,
        compensation: "$1,050 Cash",
        compensation_type: "paid",
        cash_amount: 1050,
        collab_type: "YouTube Vlog",
        creator_tier: "UGC Pro",
        deliverables: "3 UGC Reels, 5 Photos, 1 YouTube Vlog",
        deliverable_count: 9,
        deliverable_load: "Custom campaign",
        ...
        what_you_get: [
          "$1,050 cash payment upon content approval",
          "Complimentary 3-night stay included",
          "Daily private chef meals",
          "Guided Doi Suthep sunrise trek",
        ],
        what_you_deliver: "9 total deliverables across 3 formats (Custom campaign)",
        requirements: [
      ...
      },
      {
        ...
        creator_tier: "Macro",
        deliverables: "2 Influencer Reels, 1 Carousel Post, 5 Photos",
        deliverable_count: 8,
        deliverable_load: "Heavy",
        ...
        what_you_deliver: "8 total deliverables across 3 formats (Heavy load)",
        requirements: [
      ...
      },
      {
        ...
        collab_type: "Instagram Reels",
        creator_tier: "Micro Influencer",
        deliverables: "4 Influencer Reels, 10 Photos",
        ...
        what_you_deliver: "14 total deliverables across 2 formats (Custom campaign)",
        requirements: [
          "Minimum 5,000 followers on Instagram",
          "Micro Influencer or higher creator tier",
        ],
