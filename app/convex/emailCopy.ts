...
export const TEMPLATE_DEFAULTS: Record<string, TemplateDef> = {
  ...
  role_switch_invite_creator: {
    name: "Finish your profile — switched to Creator",
    trigger: "Admin approves a role switch/correction into Creator",
    category: "Account",
    vars: ["firstName"],
    calloutColor: "#8B6F52",
    copy: {
      subject: "You're approved as a Creator — one more step",
      heading: "Almost there, {{firstName}} 🔑",
      body: "You've been approved on Collabnb as a Creator. A couple of details from a host profile don't carry over, so finish your creator profile below to unlock applying to listings.",
      calloutLabel: "This link is just for you",
      calloutText: "It's a one-time link tied to your account — use it to fill in your Instagram and the rest of your creator details.",
      buttonLabel: "Finish your profile",
      footnote: "This link expires in 14 days. Need a new one? Just reply to this email.",
    },
  },
  role_switch_invite_host: {
    name: "Finish your profile — switched to Host",
    trigger: "Admin approves a role switch/correction into Host",
    category: "Account",
    vars: ["firstName"],
    calloutColor: "#8B6F52",
    copy: {
      subject: "You're approved as a Host — one more step",
      heading: "Almost there, {{firstName}} 🔑",
      body: "You've been approved on Collabnb as a Host. A couple of details from a creator profile don't carry over, so finish your host profile below to unlock publishing your first listing.",
      calloutLabel: "This link is just for you",
      calloutText: "It's a one-time link tied to your account — use it to fill in your property name, city, and website.",
      buttonLabel: "Finish your profile",
      footnote: "This link expires in 14 days. Need a new one? Just reply to this email.",
    },
  },
