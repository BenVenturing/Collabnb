...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (args.status === "published" && args.host_id) {
      ...
      if (host && !host.stripe_default_payment_method_id) {
...
const SAMPLE_LISTINGS = [
      {
        ...
        rating: 4.97,
        review_count: 84,
        compensation: "$1,200 + 3-night stay",
        ...
        deliverable_load: "Custom campaign",
        ...
        what_you_deliver: "24 total deliverables across 3 formats (Custom campaign)",
        requirements: [
      ...
      },
      {
        ...
        rating: 4.93,
        review_count: 112,
        compensation: "$750 + 2-night stay",
        compensation_type: "hybrid",
        cash_amount: 750,
        collab_type: "Instagram Reels",
        creator_tier: "Micro Influencer",
        deliverables: "3 Influencer Reels, 10 Photos, 2 Story Frames",
        ...
        what_you_deliver: "15 total deliverables across 3 formats (Heavy load)",
        requirements: [
      ...
      },
      {
        ...
        rating: 4.95,
        review_count: 203,
        compensation: "$1,100 Cash",
        compensation_type: "paid",
        cash_amount: 1100,
        collab_type: "YouTube Vlog",
        creator_tier: "UGC Pro",
        deliverables: "1 UGC Reel, 13 Photos, 1 YouTube Vlog",
        deliverable_count: 15,
        deliverable_load: "Custom campaign",
        ...
        what_you_get: [
          "$1,100 cash payment upon content approval",
          "Complimentary 3-night stay included",
          "Daily private chef meals",
          "Guided Doi Suthep sunrise trek",
        ],
        what_you_deliver: "15 total deliverables across 3 formats (Custom campaign)",
        requirements: [
      ...
      },
      {
        ...
        rating: 4.96,
        review_count: 129,
        compensation: "$900 Cash",
        compensation_type: "paid",
        cash_amount: 900,
        collab_type: "Full Package",
        creator_tier: "Macro",
        deliverables: "1 Influencer Reel, 1 Carousel Post, 16 Photos",
        ...
        what_you_get: [
          "$900 cash payment upon content approval",
      ...
      },
      {
        ...
        rating: 4.91,
        review_count: 78,
        compensation: "$850 Cash",
        compensation_type: "paid",
        cash_amount: 850,
        collab_type: "Instagram Reels",
        creator_tier: "Micro Influencer",
        deliverables: "4 Influencer Reels, 8 Photos, 2 Story Frames",
        ...
        what_you_get: [
          "$850 cash payment upon content approval",
          "Complimentary 1-night dome stay",
          "Guided stargazing session",
          "Mediterranean provisions & fire kit",
        ],
        what_you_deliver: "14 total deliverables across 3 formats (Custom campaign)",
        requirements: [
          "Minimum 5,000 followers on Instagram",
          "Micro Influencer or higher creator tier",
        ],
    ...
    for (const canonical of SAMPLE_LISTINGS as any[]) {
      ...
      if (existing) {
        await ctx.db.patch(existing._id, {
          ...
          is_featured: canonical.is_featured,
          compensation: canonical.compensation,
          compensation_type: canonical.compensation_type,
          cash_amount: canonical.cash_amount,
          deliverables: canonical.deliverables,
          deliverable_count: canonical.deliverable_count,
          deliverable_load: canonical.deliverable_load,
          what_you_get: canonical.what_you_get,
          what_you_deliver: canonical.what_you_deliver,
        });
